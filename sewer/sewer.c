/**
 * sewer.c is a javascript preprocessor
 * and entity component system
 */

/*

macros:
 - BASE64(tile_x, tile_y)                   : base64
 - BASE64(tile_x, tile_y, tile_w, tile_h)   : base64
 - BORDER(tile_x, tile_y)                   : base64
 - SHADER(file)                             : string
 - 
 - RANDOM()
 - 
...
the following is added statically to index.html
